  ...
  import { Match3Feature } from "./js/match3/match3.js?v=20260905-match3-alllevels-unified-visualfix-v15";
...
const THEME_PATH = [
  ...
  const dom = {
    ...
    screens: {
      ...
      match3Map: $("match3MapScreen"),
      match3Play: $("match3PlayScreen")
    },
    ...
    openMatch3Button: $("openMatch3Button"),
    ...
    if (screenName !== "play" && window.BKLoader && targetScreen) {
      ...
      if (pendingImages.length) {
        const labels = {
          ...
          match3Map: "Match Arena wird geladen…",
          match3Play: "Match Arena wird geladen…",
